...
const SignUp = () => {
    const { SignUpUser, updateUser } = useContext(MediplusContext)
        ...
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-50 text-gray-800 mb-24 mx-auto">
            ...
            <form onSubmit={handleSignUp} noValidate className="space-y-6">
                <div className="space-y-1 text-sm">
                    ...
                    <input type="text" name="name" id="name" placeholder="Your full name" className="w-full px-4 py-3 rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-teal-600" />
                </div>
                <div className="space-y-1 text-sm">
                ...
                <div className="space-y-1 text-sm">
                    ...
                    <input type="file" name="image" id="image" placeholder="Place your image" className="w-full px-4 py-3 rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-teal-600" />
                </div>
                <div className="space-y-1 text-sm">
                    <label className="block text-gray-600">Your Role</label>
                    <select name="role" id="role" className="w-full px-4 py-3 rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-teal-600">
                ...
                <button className="btn w-full hover:bg-teal-800 p-3 text-center rounded-sm text-gray-50 bg-teal-600">Sign Up</button>
            </form>
